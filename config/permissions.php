...
return [
    ...
    'role_permissions' => [
        ...
        'content_manager' => ['cms.pages.view', 'cms.pages.create', 'cms.pages.update', 'cms.pages.publish', 'blog.posts.view', 'blog.posts.create', 'blog.posts.update', 'blog.posts.publish', 'blog.categories.manage', 'seo.manage', 'menus.manage', 'media.manage'],
        'support' => ['forms.submissions.view', 'communications.logs.view', 'realestate.bookings.manage', 'ops.view'],
        'owner' => [],
    ],
];
